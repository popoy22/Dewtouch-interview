...
//    	echo $this->Html->css('/metronic_new/plugins/jquery-ui/jquery.ui.slider');
   ...
   ?>
    <?php 
		echo $this->Html->css('/css/additional.css'); // Added By Me
	?>
    </style>
</head>
<!-- BEGIN BODY -->

<body class="page-header-fixed page-sidebar-fixed <?php if(@$sidebar_close) echo 'page-sidebar-closed' ?>">
    <!-- BEGIN HEADER -->
    <div class="header navbar navbar-inverse navbar-fixed-top">
        <!-- BEGIN TOP NAVIGATION BAR -->
        <div class="navbar-inner">
            <div class="container-fluid">
                <?php echo $this->Html->link($this->Html->image('https://static.wixstatic.com/media/a59a36_baf7505c7d3b4ceab1831e5f1ca019be~mv2.gif',array('style'=>'height: 40px')),'/',array('escape'=>false))?>
