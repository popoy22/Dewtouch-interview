    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td>MH</td>
                <td><span class="label">CakePHP</span> <span class="label">JS</span> <span class="label">MySQL</span>
                </td>
                <td>2</td>
                <td>
            ...
            <tr>
                ...
                <td><span class="label"><?php echo __('CakePHP')?></span> <span
                        class="label"><?php echo __('JS')?></span></td>
                ...
                <td>
                    ...
                    <?php echo $this->Html->image('rating.png',array('style'=>'width: 15px'))?>
                    <span
                        style="background-color:#fafafa;width: 14px;height: 16px;display: inline-block;margin-left: -10px;/* padding: 1px; */vertical-align: bottom;"></span>
                </td>
            ...
            <tr>
                ...
                <td><?php echo $this->Html3->link('View Detail','/OrderReport/question',array('data-modal-full-width'=>true,))?>
                </td>
            ...
            <tr>
                ...
                <td><?php echo $this->Html->link('Click Me','/Member/index')?></td>
            </tr>
        </tbody>
    </table>
